...
<?php 
    ...
    //{//not present
     ...
     if(isset($_POST['updateAut'])){
        ...
        $sql= "UPDATE `branchauthor` SET `bookid`='$Book_id',`authorName`='$AuthorName' where `bookid`='$Book_id'";
    ...
    //   if (mysqli_query($conn, $sql)==TRUE) {
        ...
        header("Refresh:4; url=viewBookAuthor.php");

{
     if(isset($_GET['bookid'])){
        $Book_id=$_GET['bookid'];

        $sql="SELECT * FROM  `branchauthor` WHERE 'bookid'='$Book_id'";
...
<link href="https://fonts.googleapis.com/css2?family=Berkshire+Swash&display=swap" rel="stylesheet">
        <body>
        <div class="bg-img">
            <h2 class="h2">UPDATE BOOK AUTHORS</h2>
            <br>
            <br>
            <br>
            <br>
